...
class SliceSum {
    public int solution(int[] A) {
        ...
        System.out.println("minAvgVal: " + minAvgVal);
        System.out.println("minAvgIdx: " + minAvgIdx);
        return minAvgIdx;
    }

    public static void main(String [] args) {
        SliceSum ss = new SliceSum();
        ss.solution(new int[] {4, 2, 2, 5, 1, 5, 8});
        ss.solution(new int[] {2, 2, 2, -5, -5, -5});
    }
}